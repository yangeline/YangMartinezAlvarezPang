...
emissions_comparison_plot <- ggplot(similar_states_emissions, aes(x = State, y = `Emission 2019`, fill = State)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  ggtitle("CO2 Emissions in 2019 for States with GDP Growth") +
  xlab("State") +
...
To breifly compare policy landscape between these states, we will be looking at three parts, whether they have Green House Gas (GHG) emission goals, Climate Action Plans, and how strictly have they been implemented. States that had their Green House Gas (GHG) emission goals written into statue, will be considered to be a more strict policy, and if a state only listed as an executive goal.
