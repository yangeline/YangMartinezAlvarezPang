...
```{r NC.Emission.byfuel, fig.height=10, fig.width=10, echo=F, error=F, message=FALSE, warning=F}
...
```{r, GDP.CO2.comparables, echo=F, error=F, message=FALSE, warning=F}
...
```{r, echo=F, error=F, message=FALSE, warning=F}
...
```{r, Ge.bysector, echo=F, error=F, message=FALSE, warning=F}
...
```{r, Georgia.byfuel, fig.height=10, fig.width=10, echo=F, error=F, message=FALSE, warning=F}
...
```{r, Virginia.bysector, echo=F, error=F, message=FALSE, warning=F}
...
```{r, Vi.Emission.byfuel, fig.height=10, fig.width=10, echo=F, error=F, message=FALSE, warning=F}
